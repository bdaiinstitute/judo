...
from judo.utils.mujoco_new import RolloutBackend, SimBackend
...
@dataclass
class CylinderPushNewConfig(TaskConfig):
...
class CylinderPushNew(Task[CylinderPushNewConfig]):
